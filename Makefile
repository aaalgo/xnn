...
CXX=g++
CFLAGS += -O3 -g
CXXFLAGS += -std=c++11 -O3 -fopenmp -g -I/usr/include/python2.7 -I/usr/local/cuda/include #-DCPU_ONLY=1 #-I/opt/caffe-fcn/include -I/usr/local/cuda/include
...
xnn-roc:	xnn-roc.o $(COMMON)
	g++ $(LDFLAGS) -o $@ $^ -lpicpac $(LDLIBS)
